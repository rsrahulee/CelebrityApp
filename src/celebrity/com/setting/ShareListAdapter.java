...
public class ShareListAdapter extends BaseAdapter {
	...
	public ShareListAdapter(Context context,  ArrayList<String>  shareItems,MainScreen mainContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position == 0) {
//			boolean facebook_on = CheckinNativeActivity.appStatus.
//			                      getSharedBoolValue(CheckinNativeActivity.appStatus.FACEBOOK_ON); 
//			if(facebook_on) {
//				tb.setChecked(true);
//			} else {
//				tb.setChecked(false);
...
//			boolean twitter_on = CheckinNativeActivity.appStatus.
//                                 getSharedBoolValue(CheckinNativeActivity.appStatus.TWITTER_ON); 
//
//			if(twitter_on) {
//				tb.setChecked(true);
//			} else {
...
//					bReturnStatus=true;
//				} else {
//					CheckinNativeActivity.appStatus.saveSharedBoolValue(CheckinNativeActivity.
